...
export function usage(): string {
  ...
  return [
    ...
    ` ${n} studio [--writable]`,
    ` ${n} studio serve --port <port> [--host <host>] [--writable]`,
    ` ${n} config`,
    ` ${n} claude [args...] (after --: --no-git, --companion, --yes; TTY launches confirm by default)`,
    ` ${n} opencode [args...] (after --: --no-git, --companion, --yes; TTY launches confirm by default)`,
