...
companion policy allows that provider.
...
separator. All other arguments after the separator are forwarded to the agent. Codex
launches require Codex CLI 0.145.0 or newer.
