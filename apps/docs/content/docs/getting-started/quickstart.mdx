---
title: Quickstart
description: Install Mate, link a companion, and launch a coding agent.
---
...
Start an allowed provider from the working repository:
...
Mate resolves the linked project, applies the repository's selected profile
and any `overrides.allowedAgents`, syncs the companion instructions and
...
See [Capabilities](/mate-cli/capabilities) for the optional tools Mate can wire into the flow.
