...
`mate companion link`, then `mate opencode`, `mate claude`, or `mate codex`.
Linking selects or clones a companion and completes the installation of its
selected requirements before the first launch.
